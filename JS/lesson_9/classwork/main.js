...
//
// for (const simpson of simpsons) {
//     let simpsonsDivElement = document.createElement('div');
...
//
//
//     simpsonsDivElement.appendChild(name);
//     simpsonsDivElement.appendChild(surname);
//     simpsonsDivElement.appendChild(age);
//     simpsonsDivElement.appendChild(info);
//     simpsonsDivElement.appendChild(imgDiv)
//     imgDiv.appendChild(img);
//     simpsonsDivElement.classList.add('member');
//     document.body.append(simpsonsDivElement);
// }
