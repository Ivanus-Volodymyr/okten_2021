...
// //     let family = simpsons[i]
// //     document.write(`<div class="home-block"><p>${family.name} ${family.surname} ${family.age} ${family.info} </p> <img class="img" src="${family.photo}" alt=""></div>`)
// // }
// // document.write(`</div>`)
//
// // //template 2.2
...
// // for (let i = 0; i < simpsons.length; i++) {
// //     let family = simpsons[i]
// //     document.write(`<div class="home-block">
// //     <h2>${family.name} ${family.surname} age is ${family.age}</h2>
// //     <p>${family.info}</p>
// //     <img class="img" src="${family.photo}" alt="">
// //     </div>`)
// // }
// // document.write(`</div>`)
...
//     <h3 class="product-title">${product.title} Prisre ${product.price}</h3>
